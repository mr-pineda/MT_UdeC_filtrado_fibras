...
int main(){
    ...
    char output_dir[PATH_MAX];  //Directorio donde se guardar�n los archivos creados
    char newName[60];           //Prefijo que se le a�adir� a los archivos de salida

    /// Variables relacionadas con fibras
    fasciculus bundleIn;    //Guarda los datos leidos de los archivos
    fasciculus bundleOut;   //Guarda los datos que se escribir�n en archivos
...
//    clock_t start;
    ...
    strcat(output_dir,"/SSDPD3D_C"); //Algoritmo an�logo para el directorio de salida
