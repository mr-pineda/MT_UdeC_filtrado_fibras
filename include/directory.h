...
bool endAnalyser(char *terminator, char *file_name);               // Verifica si un archivo tiene una extensi�n espec�fica
char **extFinder(char *cdir, char *ext, int *n);                   // Crea una lista de strings de archivos con una extensi�n espec�fica
